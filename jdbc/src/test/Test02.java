...
public class Test02 {
	...
	public static void main(String[] args) {
		...
		String sql=
		"select e.ename as \"사원명\", e.sal as \"사원급여\", m.ename as \"상사명\", m.sal as \"상사급여\" "+
		"from emp e "+
			"join emp m "+
			"on e.mgr = m.empno " +
		"where e.sal>m.sal";
		...
		Statement st = null;   // sql 구문을 관리하는 객체 Statement
		ResultSet rs = null;   // ResultSet은  위의 sql구문 select의 결과값을 받을 객체 //결과값 테이블을 자바에서는 resultSet이라고 부름 
